...
Funcionalidade: Receber pedido de locação
    ...
    Cenario: Receber pedido
        ...
        Dado que meu perfil de anunciante é "anunciante@mail.com" e "teste652"
        ...
        Quando "locatario@mail.com" e "teste652" solicita a locação desse equipo
        Então devo ver a seguinte mensagem:
            """
            locatario@mail.com deseja alugar o equipamento: Trompete em: DATA_ATUAL
            """
